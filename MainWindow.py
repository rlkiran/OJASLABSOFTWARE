...
class Ui(QtWidgets.QMainWindow):
    ...
    def setTestData(self):
        global temp
        temp = firebaseTest.getCollectionList()
        self.TestsList.addItem("--")
        self.TestsList.addItems(temp.copy())
    ...
    def setParams(self):
        ...
        paramData.append(FireTest.getDocuments(self.TestsList.currentText()))
        for pD in paramData:
            for p in pD:
    ...
    def sendUserDataToDoc(self):
        ...
        mixedTemplateScript.addPatientDetails(docLoc, filename, **wordFields)
